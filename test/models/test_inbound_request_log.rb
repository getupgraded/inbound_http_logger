...
class InboundRequestLogValidationsTest < Minitest::Test
  def setup
    super
...
class InboundRequestLogScopesTest < Minitest::Test
  def setup
    super
    @model = InboundHTTPLogger::Models::InboundRequestLog
...
class InboundRequestLogLogRequestTest < Minitest::Test
  def setup
    super
    @model = InboundHTTPLogger::Models::InboundRequestLog
...
class InboundRequestLogInstanceMethodsTest < Minitest::Test
  def setup
    super
    @model = InboundHTTPLogger::Models::InboundRequestLog
    @log = @model.create!(
...
class InboundRequestLogSearchTest < Minitest::Test
  def setup
    super
    @model = InboundHTTPLogger::Models::InboundRequestLog
...
class InboundRequestLogCleanupTest < Minitest::Test
  def setup
    super
    @model = InboundHTTPLogger::Models::InboundRequestLog
  end
