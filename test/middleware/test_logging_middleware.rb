...
class LoggingMiddlewareEnabledTest < Minitest::Test
  def setup
    super
...
class LoggingMiddlewareDisabledTest < Minitest::Test
  def setup
    super
...
class LoggingMiddlewareControllerExclusionsTest < Minitest::Test
  def setup
    super
    InboundHTTPLogger.enable!
    @app = ->(_env) { [200, { 'Content-Type' => 'application/json' }, ['{"success": true}']] }
