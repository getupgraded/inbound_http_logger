...
class InboundHTTPLoggerTest < Minitest::Test
  def test_has_a_version_number
    refute_nil ::InboundHTTPLogger::VERSION
  end
end

class InboundHTTPLoggerConfigurationTest < Minitest::Test
...
class InboundHTTPLoggerControllerFilteringTest < Minitest::Test
  def setup
    super
    InboundHTTPLogger.enable!
  end
...
class InboundHTTPLoggerThreadLocalDataTest < Minitest::Test
