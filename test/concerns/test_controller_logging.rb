...
class ControllerLoggingModuleMethodsTest < Minitest::Test
  def setup
    super
...
class ControllerLoggingSetupTest < Minitest::Test
  def setup
    super
    # Clear thread-local data before each test
    Thread.current[:inbound_http_logger_metadata] = nil
...
class ControllerLoggingLogRequestsTest < Minitest::Test
  def setup
    super
...
class ControllerLoggingInheritanceTest < Minitest::Test
  def setup
    super
    @controller_base_class = Class.new do
      # Mock Rails controller methods
...
class ControllerLoggingContextCallbacksTest < Minitest::Test
  def setup
    super
    @controller_base_class = Class.new do
      # Mock Rails controller methods
...
class ControllerLoggingInheritanceChainCallbackTest < Minitest::Test
  def setup
    super
