  ...
  module Models
    class InboundRequestLog < ActiveRecord::Base
      ...
      class << self
        ...
        def using_jsonb?
          # Use a class variable for thread-safe memoization with error handling
          @@using_jsonb ||= begin
        ...
        def reset_adapter_cache!
          # This method exists for compatibility with test helpers
          # InboundHTTPLogger doesn't currently cache adapters at the model level
          # but this method is called by test helpers for consistency
        end
